...
public class JukeboxInterface {
    ...
    public static Movie cloneMovie(Movie movie) {
        ...
        newMovie.setContainer(movie.getContainer());
        newMovie.setFile(movie.getFile());
        newMovie.setContainerFile(movie.getContainerFile());
        newMovie.setAspectRatio(movie.getAspectRatio());
        ...
        newMovie.setFps(movie.getFps());
        newMovie.setResolution(movie.getResolution());
        ...
        movie.setVideoOutput(movie.getVideoOutput());
        movie.setVideoSource(movie.getVideoSource());
