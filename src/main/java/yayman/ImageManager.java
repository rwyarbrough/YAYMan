...
public class ImageManager extends javax.swing.JDialog {
    ...
    */
    ...
    private void loadAttachmentImages() {
        ...
        if (tmpDir.isDirectory() && tmpDir.exists()) tmpDir.delete();
        ...
        if (mtn.isValid()) {
            try {
                ...
                for (int i=0; i < files.length; i++) {
                    ...
                    System.out.println(mFile.getFile().getPath());
                    ...
                    for (Mkvtoolnix.Attachment attach : attachments) {
                        System.out.println("Crated attachment: "+attach);
                        allAttach.add(attach);
                    }
                }
                ArrayList<File> attachImageFiles = mtn.getImageAttachmentFiles(allAttach, "");
