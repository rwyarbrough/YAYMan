...
public class YAYManAboutBox extends javax.swing.JDialog {

    public YAYManAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(yayman.YAYManApp.class).getContext().getActionMap(YAYManAboutBox.class, this);
    ...
    private void appHomepageLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_appHomepageLabelMouseClicked
        try {
            ...
            java.awt.Desktop.getDesktop().browse(new URI(label.getText()));
        } catch (Exception ex) {
            //System.out.println(ex.toString());
            //ErrorOut.logError(ex);
            YAYManView.logger.severe("Error launching web page: "+ex);
        }
